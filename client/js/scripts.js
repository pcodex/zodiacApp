...
function getData()
{
	var usrinp = document.getElementById('user-search').value.toLowerCase();
	
	for(var i=0; i<zodiacs.length;i++)
	{		

		if (usrinp === zodiacs[i].name.toLowerCase())
		{
			document.getElementById('name').innerHTML = zodiacs[i].name;
			document.getElementById('date').innerHTML = zodiacs[i].month;
			document.getElementById('imgzodiac').src = zodiacs[i].image;
